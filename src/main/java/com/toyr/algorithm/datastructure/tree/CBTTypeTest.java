package com.toyr.algorithm.datastructure.tree;
 ...
 * @author unisk1123
 * @Description
 * @create 2020-03-26 9:48 PM
 */
public class CBTTypeTest {
    ...
    int TreeDepth(CBTType treeNode) {                   // 计数二叉树深度
    ...
    void TreeNodeData(CBTType p) {              // 显示结点数据
        System.out.printf("%s ", p.data);        // 输出节点数据
    }
